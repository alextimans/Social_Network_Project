...
\- There is very high accordance of ap\_top\_terms with the gay\_dtm values with highest counts, i.e. words that have high counts are also identified as words representing the topic (makes sense) 
